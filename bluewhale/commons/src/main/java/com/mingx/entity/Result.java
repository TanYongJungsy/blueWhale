...
public class Result<T> implements Serializable {
    ...
    public static <T> Result<T> succeed() {
        return succeedWith(null, CodeEnum.SUCCESS.getCode(), "ok");
    }
    ...
    public static <T> Result<T> noRegister(String msg) {
        return failedWith(null, CodeEnum.NOREGISTER.getCode(), msg);
    }
